...
-- Average uses applicative with `Control.Foldl` in order to traverse the list only
-- once.
...
main =
    runZMQ $ do
        ...
        liftIO $ putStrLn "Established client..."
        ...
        liftIO $ printf "NY City: avg temp of %.1fC and avg hum of %.1f%%\n"
